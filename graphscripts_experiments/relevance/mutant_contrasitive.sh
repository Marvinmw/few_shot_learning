...
for loss in CE CT 
do
output_folder=results/mutants_class_contrastive_${num_class}_${p}_${loss}/context
bash mutant_prediction.sh gat "pretrained_models/context/gat/model_0" ${output_folder}/ attention $device $num_class $p $loss
done
done
