...
lstm_emb_dim=150
mkdir -p $output
python mutants_siamese.py --batch_size 256 --num_workers 5  --epochs 50 --num_layer 5 \
...
--loss $loss \
--saved_model_file -1 \
--projects Lang JacksonXml Jsoup Compress Chart Cli Csv Gson JacksonDetabind
