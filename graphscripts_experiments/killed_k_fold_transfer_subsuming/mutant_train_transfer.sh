...
#SBATCH --qos=normal
#SBATCH -J killed_k_fold_transfer
...
for loss in SCL CE
do
output_folder=results/supervised_killed_subsuming_transferweights/${loss}/mutants_${num_class}_loss_${loss}_train_${train_project}/context
