...
from utils.mutantsdataset_relevance import MutantsReDataset, balanced_oversample
import argparse
import json
...
def fecth_datalist(args, projects):
    ...
    for p in projects:
        ...
        dataset_inmemory = MutantsReDataset( args.dataset_path , dataname=args.dataset, project=p)
